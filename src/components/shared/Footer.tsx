...
const Footer = () => {
  ...
  return (
    <div className="bg-[#000] text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center">
      ...
      >
        <span>© {new Date().getFullYear()} KEYGEM. All rights reserved.</span>
